...
public class yal2jvm/*@bgen(jjtree)*/implements yal2jvmTreeConstants, yal2jvmConstants {/*@bgen(jjtree)*/
  protected static JJTyal2jvmState jjtree = new JJTyal2jvmState();static java.util.Stack argStack;
        public static void main(String[] args) throws ParseException{
                ...
                try {
                        ...
                        System.out.println("\u005cn\u005cnCommencing Semantic Analysis.");
                        System.out.println("Checking Operations.\u005cn");
                        ...
                        if (!symbolTable.hasErrors()) {
                                ...
                                System.out.println("\u005cnCode Generation Done. \u005cn");
                        }
...
*/
  static final public void Declaration() throws ParseException {
                     ...
                     boolean jjtc000 = true;
                     jjtree.openNodeScope(jjtn000);String declaration; Token tmp; Token tmp2;
    try {
      try {
        ...
        case 32:
          ArrayElement(tmp);
                                      jjtn000.setType(Utils.DECLARATION_ARRAY);
          break;
        default:
          jj_la1[4] = jj_gen;
          ;
        ...
        case ASSIGN:
          ...
          case INTEGER:
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
            case ADDSUB_OP:
              tmp = jj_consume_token(ADDSUB_OP);
                         jjtn000.setOperator(tmp.image);
              break;
            default:
              jj_la1[5] = jj_gen;
              ;
            ...
            tmp2 = jj_consume_token(INTEGER);
                                                                             jjtn000.setAssigned(tmp2.image); jjtn000.setType(Utils.DECLARATION_SCALAR);
            break;
          default:
            jj_la1[6] = jj_gen;
            jj_consume_token(-1);
    ...
    try {
      jj_consume_token(LCHAVETA);
                ...
                System.out.println("Error on statement list, opening bracket not detected."
                        +"\u005cnSpecific exception: " + e.toString());
    ...
    try {
      ...
      default:
        ...
        throw new ParseException();
                ...
                System.out.println("Error on a statement, maybe missing ';'\u005cnSpecific Exception thrown: ."
                + e.toString());
                error_skipto(PVIRG);
    }
  }
...
*/
  static final public void Call(Token t) throws ParseException {
                     /*@bgen(jjtree) Call */
 ...
 * @param Token t contains ID information for printing.
*/
  static final public void Assign(Token t) throws ParseException {
                       /*@bgen(jjtree) Assign */
...
*/
  static final public void LhsNoID(Token t) throws ParseException {
                              String tmp;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 32:
      ArrayAccess(t);
      ...
      try {
        ...
        default:
          ...
          throw new ParseException();
                ...
                System.out.println("Error on rhs.\u005cnSpecific Exception thrown: " + e.toString());
      ...
      try {
        ...
        case INTEGER:
          t = jj_consume_token(INTEGER);
                                jjtn000.setType(Utils.NUMBER); jjtn000.value = t.image;
          break;
        case ID:
          t = jj_consume_token(ID);
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        ...
        default:
          ...
          throw new ParseException();
                ...
                System.out.println("Error on term.\u005cnSpecific Exception: " + e.toString());
                error_skipto_withoutconsuming(PVIRG);
      }
    } catch (Throwable jjte000) {
          if (jjtc000) {
    ...
    try {
      try {
        ...
        Lhs();
                ...
                System.out.println("Invalid opening condition for structure. \u005cnSpecific Exception thrown: "
                 + e.toString());
      ...
      try {
        ...
        default:
          ...
          ;
                ...
                System.out.println("Invalid argument. \u005cnSpecific Exception thrown: " + e.toString());
                error_skipto(RPAR);
      }
    } catch (Throwable jjte000) {
          if (jjtc000) {
...
*/
  static final public void ArrayAccess(Token content) throws ParseException {
    ...
    try {
      ...
      jj_consume_token(33);
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
         jjtn000.content = content.image; jjtn000.index = index;
    } catch (Throwable jjte000) {
          if (jjtc000) {
            jjtree.clearNodeScope(jjtn000);
            jjtc000 = false;
  ...
  static final public void ArrayInstantion() throws ParseException {
                          /*@bgen(jjtree) ArrayInstantion */
...
*/
  static final public void ScalarAccess(Token content) throws ParseException {
...
*/
  ...
  static final public void Var() throws ParseException {
    ...
    try {
      ...
      case 32:
        ArrayElement(t);
                          jjtn000.value = null; jjtn000.setType(Utils.ARRAY);
        break;
      default:
        jj_la1[30] = jj_gen;
        ;
 ...
 * error recovery.
*/
  static final public void ArrayElement(Token t) throws ParseException {
...
try {Token t;
  ...
  static void error_skipto_unless(int kind, int stopKind) throws ParseException {
                                                  /*@bgen(jjtree) error_skipto_unless */
...
try {Token t;
  ...
  static void error_skipto_withoutconsuming(int kind) throws ParseException {
                                              /*@bgen(jjtree) error_skipto_withoutconsuming */
...
try {Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000000,0x1000000,0x0,0x8000,0x0,0x100,0x8000100,0x8000,0x80000,0x10000000,0x10003000,0x208000,0x10003000,0x200000,0x4000,0x0,0x0,0x780,0x780,0x18000180,0x180,0x180,0x0,0x18000000,0x80000,0x98000000,0x98000000,0x0,0x200000,0x18000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1,0x1,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,};
   }
